...
def frame_sequence(states_by_name: dict) -> list[tuple[str, int]]:
    ...
    add("tool_bash", count=2, dwell_ms=750)
    add("tool_read_file", count=2, dwell_ms=1000)
    add("tool_edit_file", count=2, dwell_ms=1000)
    add("thinking", count=1, dwell_ms=1500)
    add("tool_write_file", count=2, dwell_ms=750)
    add("tool_find_files", count=2, dwell_ms=1000)
    add("tool_python", count=2, dwell_ms=750)
    add("thinking", count=2, dwell_ms=1500)
